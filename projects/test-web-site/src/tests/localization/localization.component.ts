...
export class LocalizationComponent {
  ...
  get getNumber(): string {
    return this.translation.number( this.longNumber, 'maxfd=2' );
  }

  get getPercent(): string {
    return this.translation.percent( this.shortPercent, 'minfd=1' );
  }

  get getCurrency(): string {
    return this.translation.currency( this.priceE.price );
  }

  get getCcy(): string {
    return this.translation.ccy( this.ccyValue, this.ccyCurr );
  }

  get getDatetime(): string {
    return this.translation.datetime( this.now, 'ds=medium;ts=medium' );
  }
}
